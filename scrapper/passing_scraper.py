#!/usr/bin/env python3
"""
Scraper especializado para datos de Passing de NBA
"""
...
class PassingScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Passing
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Passing
        """
        return "table[data-module='Passing']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Passing
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("passing").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Passing: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Passing
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Passing
            numeric_columns = [
                "PASS",
                "PASS_MADE",
                "PASS_RECEIVED",
