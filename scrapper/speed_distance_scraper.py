#!/usr/bin/env python3
"""
Scraper especializado para datos de Speed Distance de NBA
"""
...
class SpeedDistanceScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Speed Distance
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Speed Distance
        """
        return "table[data-module='Speeddistance']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Speed Distance
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("speed_distance").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Speed Distance: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Speed Distance
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Speed Distance
            numeric_columns = [
