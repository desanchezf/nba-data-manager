...
class BoxscoreScraper(BaseScraper):
    ...
    # ========================================================================
    # MÉTODOS ABSTRACTOS IMPLEMENTADOS (override de clase base)
    # ========================================================================
    ...
    # ========================================================================
    # MÉTODOS PÚBLICOS PRINCIPALES (API pública de la clase)
    # ========================================================================
    ...
    def save_to_database(self, data, url, season=None, season_type=None):
        ...
        try:
            ...
            # Guardar en la base de datos usando update_or_create
            saved_count = 0
    ...
    # ========================================================================
    # MÉTODOS DE NAVEGACIÓN Y PAGINACIÓN (privados)
    # ========================================================================
    ...
    # ========================================================================
    # MÉTODOS DE PROCESAMIENTO DE DATOS (privados)
    # ========================================================================
        ...
        try:
            for row in df.iter_rows(named=True):
                try:
                    ...
                    # Usar game_id si está disponible
    ...
    # ========================================================================
    # MÉTODOS UTILITARIOS (privados, helpers)
    # ========================================================================
