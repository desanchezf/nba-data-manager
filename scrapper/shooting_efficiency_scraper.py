#!/usr/bin/env python3
"""
Scraper especializado para datos de Shooting Efficiency de NBA
"""
...
class ShootingEfficiencyScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Shooting Efficiency
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Shooting Efficiency
        """
        return "table[data-module='Shootingefficiency']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Shooting Efficiency
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("shooting_efficiency").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Shooting Efficiency: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Shooting Efficiency
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Shooting Efficiency
            numeric_columns = [
