#!/usr/bin/env python3
"""
Scraper especializado para datos de Elbow Touch de NBA
"""
...
class ElbowTouchScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Elbow Touch
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Elbow Touch
        """
        return "table[data-module='Elbowtouch']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Elbow Touch
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("elbow_touch").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Elbow Touch: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Elbow Touch
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Elbow Touch
            numeric_columns = [
