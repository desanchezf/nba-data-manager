#!/usr/bin/env python3
"""
Scraper especializado para datos de Defensive Impact de NBA
"""
...
class DefensiveImpactScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Defensive Impact
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Defensive Impact
        """
        return "table[data-module='Defensiveimpact']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Defensive Impact
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("defensive_impact").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Defensive Impact: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Defensive Impact
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Defensive Impact
            numeric_columns = [
