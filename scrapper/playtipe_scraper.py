#!/usr/bin/env python3
"""
Scraper especializado para datos de Playtipe de NBA
"""
...
class PlaytipeScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Playtipe
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Playtipe
        """
        return "table[data-module='Playtipe']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Playtipe
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("playtipe").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Playtipe: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Playtipe
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Playtipe
            numeric_columns = [
