#!/usr/bin/env python3
"""
Scraper especializado para datos de Pull Up Shooting de NBA
"""
...
class PullUpShootingScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Pull Up Shooting
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Pull Up Shooting
        """
        return "table[data-module='Pullupshooting']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Pull Up Shooting
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("pull_up_shooting").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Pull Up Shooting: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Pull Up Shooting
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Pull Up Shooting
            numeric_columns = [
