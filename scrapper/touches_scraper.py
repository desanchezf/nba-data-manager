#!/usr/bin/env python3
"""
Scraper especializado para datos de Touches de NBA
"""
...
class TouchesScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Touches
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Touches
        """
        return "table[data-module='Touches']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Touches
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("touches").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Touches: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Touches
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Touches
            numeric_columns = [
