#!/usr/bin/env python3
"""
Scraper especializado para datos de Shooting de NBA
"""
...
class ShootingScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Shooting
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Shooting
        """
        return "table[data-module='Shooting']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Shooting
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("shooting").alias("category"))
            ...
            self.logger.error(f"Error extrayendo datos de Shooting: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Shooting
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Shooting
            numeric_columns = [
                "FGM",
                "FGA",
                "FG%",
