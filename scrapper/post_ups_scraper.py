#!/usr/bin/env python3
"""
Scraper especializado para datos de Post Ups de NBA
"""
...
class PostUpsScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Post Ups
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Post Ups
        """
        return "table[data-module='Postups']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Post Ups
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("post_ups").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Post Ups: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Post Ups
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Post Ups
            numeric_columns = [
