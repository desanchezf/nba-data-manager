#!/usr/bin/env python3
"""
Scraper especializado para datos de Defensive Rebounding de NBA
"""
...
class DefensiveReboundingScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Defensive Rebounding
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Defensive Rebounding
        """
        return "table[data-module='Defensiverebounding']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Defensive Rebounding
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("defensive_rebounding").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Defensive Rebounding: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Defensive Rebounding
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Defensive Rebounding
            numeric_columns = [
