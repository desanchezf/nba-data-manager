#!/usr/bin/env python3
"""
Scraper especializado para datos de Rebounding de NBA
"""
...
class ReboundingScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Rebounding
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Rebounding
        """
        return "table[data-module='Rebounding']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Rebounding
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("rebounding").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Rebounding: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Rebounding
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Rebounding
            numeric_columns = [
