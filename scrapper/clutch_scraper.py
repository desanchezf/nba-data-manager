#!/usr/bin/env python3
"""
Scraper especializado para datos de Clutch de NBA
"""
...
class ClutchScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Clutch
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Clutch
        """
        return "table[data-module='Clutch']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Clutch
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("clutch").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Clutch: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Clutch
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Clutch
            numeric_columns = [
