#!/usr/bin/env python3
"""
Scraper especializado para datos de Hustle de NBA
"""
...
class HustleScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Hustle
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Hustle
        """
        return "table[data-module='Hustle']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Hustle
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("hustle").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Hustle: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Hustle
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Hustle
            numeric_columns = [
