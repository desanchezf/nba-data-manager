#!/usr/bin/env python3
"""
Scraper especializado para datos de Paint Touch de NBA
"""
...
class PaintTouchScraper(BaseNBAScraper):
    """
    Scraper especializado para datos de Paint Touch
    """

    def get_table_selector(self):
        """
        Selector específico para la tabla de Paint Touch
        """
        return "table[data-module='Painttouch']"

    def extract_data(self, url):
        """
        Extrae datos específicos de Paint Touch
        ...
        try:
            ...
            if rows and headers:
                ...
                df = df.with_columns(pl.lit("paint_touch").alias("category"))
            ...
            logger.error(f"Error extrayendo datos de Paint Touch: {e}")
            return pl.DataFrame()

    def _clean_data(self, df):
        """
        Limpia y procesa los datos específicos de Paint Touch
        ...
        """
        try:
            # Convertir columnas numéricas específicas de Paint Touch
            numeric_columns = [
