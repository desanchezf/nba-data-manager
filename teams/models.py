...
class TeamsGeneralTraditional(models.Model):
    ...
    blka = models.IntegerField(default=0, null=True, blank=True)
    pf = models.IntegerField(default=0, null=True, blank=True)
    pfd = models.IntegerField(default=0, null=True, blank=True)
...
class TeamsGeneralAdvanced(models.Model):
    ...
    lose = models.IntegerField(default=0, null=True, blank=True)
    min = models.IntegerField(default=0, null=True, blank=True)
    off_rating = models.FloatField(default=0.0, null=True, blank=True)
    def_rating = models.FloatField(default=0.0, null=True, blank=True)
    net_rating = models.FloatField(default=0.0, null=True, blank=True)
    ast_pct = models.FloatField(default=0.0, null=True, blank=True)
    ast_to = models.FloatField(default=0.0, null=True, blank=True)
    ast_ratio = models.FloatField(default=0.0, null=True, blank=True)
    oreb_pct = models.FloatField(default=0.0, null=True, blank=True)
    dreb_pct = models.FloatField(default=0.0, null=True, blank=True)
    reb_pct = models.FloatField(default=0.0, null=True, blank=True)
    tm_tov_pct = models.FloatField(default=0.0, null=True, blank=True)
    efg_pct = models.FloatField(default=0.0, null=True, blank=True)
    ts_pct = models.FloatField(default=0.0, null=True, blank=True)
    pace = models.FloatField(default=0.0, null=True, blank=True)
    pie = models.FloatField(default=0.0, null=True, blank=True)
    poss = models.IntegerField(default=0, null=True, blank=True)
